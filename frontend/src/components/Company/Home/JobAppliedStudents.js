...
class JobAppliedStudents extends React.Component {
  ...
  setStatus(applicationId, passedStatus) {
    this.props.updateStudentStatus({
      status: passedStatus, jobApplicationId: applicationId, jobId: this.props.location.state.jobId, emailId: localStorage.getItem('email_id'),
    });
  }
...
export default connect(mapStateToProps, {
  getStudentProfileAppliedInJob, updateStudentStatus, updateApplyForJobStatus, listCreatedJobs,
})(JobAppliedStudents);
