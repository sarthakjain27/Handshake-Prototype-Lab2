    ...
    return(
      <div>
        ...
        <Card border="primary" className="text-center">
          <Card.Body>
            <Card.Title>
              {this.capitalize(this.props.post.title)} | {this.capitalize(this.props.post.category)}
            </Card.Title>
          ...
          <Card.Footer >
            <b>Posting Date: </b> <i>{this.props.post.postingDate}</i> {' '}
            <b>Deadline: </b> <i>{this.props.post.deadlineDate}</i>
          </Card.Footer>
        </Card>
        <br/>
      </div>
