...
const addMessageInAConversation = (req, res) => {
  ...
  kafka.make_request('addMessageInAConversation', req.body, (err, results) => {
    if (err) {
      res.send('Error');
    } else {
      res.send(results);
...
const getAllMessageOFAConversation = (req, res) => {
  ...
  console.log(req.body);
  kafka.make_request('getAllMessageOFAConversation', req.body, (err, results) => {
    if (err) {
      res.send('Error');
    } else {
      res.send(results);
...
const getAllConversations = (req, res) => {
  ...
  console.log(req.body);
  kafka.make_request('getAllConversationsOfAUser', req.body, (err, results) => {
    if (err) {
      res.send('Error');
    } else {
      res.send(results);
